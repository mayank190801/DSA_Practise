...
public class foreverWinter {
    ...
    public static void main(String[] args) {
        ...
        // should be easy enough, it is more about are you able to code this stuff?? --
        // older me could code this in actually 4-5 mins
        int t = sc.nextInt();
        while (t-- > 0) {
            int n = sc.nextInt();
            int m = sc.nextInt();

            ArrayList<Integer>[] graph = new ArrayList[n + 1]; // make the graph, simple -- yehi theek hai shayad
                                                               // approach
            for (int i = 0; i <= n; i++) {
