...
public class abba {
    ...
    public static void main(String[] args) {
        ...
        while (test-- > 0) {
            ...
            // now count a and b in this char
            // Also count the consecutive a biggest number
            int a = 0, b = 0, minA = Integer.MAX_VALUE, currA = 0, maxB = 0, currB = 0;
            ...
            if (maxB > 1 || inp[0] == 'B' || inp[inp.length - 1] == 'B') {
                out.println(a);
                continue;
            }
            out.println(a - minA);
