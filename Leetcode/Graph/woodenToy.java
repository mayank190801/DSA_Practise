...
public class woodenToy {
    ...
    public static void main(String[] args) {
        ...
        // how to write code for binary search
        int test = sc.nextInt();
        while (test-- > 0) {
            int n = sc.nextInt();
            int[] arr = new int[n];
            ...
            // it somehow works, now simple get the answer in boolean from a function
            int l = 0;
            int r = 1_000_000_000;
    ...
    public static boolean checkPossible(int n, int[] arr, int mid) {
        int left = 3;
        int limit = -1;
        for (int i = 0; i < n; i++) {
            int get = arr[i];
