...
public class curse {
    ...
    public static void main(String[] args) {
        ...
        while (test-- > 0) {
            ...
            // otherwise we know its same
            // 2 3 4 5 - only cases to be checked or whatever you wanna do
            // case wise sovle it easier in this case -
            if (n == 2 || n == 3) {
                if (!s1.equals(s2)) {
                    out.println("NO");
                    continue;
