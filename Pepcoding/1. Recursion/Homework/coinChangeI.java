...
public class coinChangeI{
    ...
    public static void coinChangeCombOne(int i, int[] coins, int amtsf, int tamt, String asf){
        ...
        for(int idx = i; idx < coins.length; idx++){
            if(coins[idx] + amtsf <= tamt){
                coinChangeCombOne(idx+1, coins, amtsf + coins[idx], tamt, asf + coins[idx] + "-");
            }
        }
    }
    ...
    //
    public static void coinChangePermOne(int[] coins, int amtsf, int tamt, String asf, boolean[] used){
        ...
        for(int idx = 0; idx < coins.length; idx++){
            ...
            used[idx] = true;
            if(coins[idx] + amtsf <= tamt){
                coinChangePermOne(coins, amtsf + coins[idx], tamt, asf+coins[idx] + "-", used);
            }
            used[idx] = false;
        }
    ...
    public static void coinChangePermTwo(int[] coins, int amtsf, int tamt, String asf) {
        // write your code here
        if(amtsf == tamt){
            System.out.println(asf + ".");
            return;
        ...
        for(int i = 0; i < coins.length; i++){
            if(coins[i] + amtsf <= tamt){
                coinChangePermTwo(coins, amtsf+coins[i], tamt, asf+coins[i]+'-');
            }
        }
