...
public class june24que1 {
    ...
    // we could have done these both steps in a single go, that is ofc pretty smart
    // way of coding this problem
    // let's figure it out and never give up
    public static List<List<Integer>> findMatrix(int[] nums) {
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            highest = Math.max(highest, map.get(nums[i]));
        }
        List<List<Integer>> ans = new ArrayList<>(highest);
