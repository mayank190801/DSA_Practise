...
public class may15que1{
    ...
    public static void main(String[] args) {
        ...
        //code here --- kaafi time lg gya tho, no worries, 
        int test = sc.nextInt();
        while(test--> 0){
            ...
            for(int i = 0; i < 26; i++){
                char curr = (char)(start + i);
                
                //now taking one alphabet, and making an arraylist out of it 
                //you just required the biggest space, so no need of this array tbh,
                //be extremely precise of what you want, and don't write uncessary code
                ...
                //ek baar end mein as well please
                spaces.add(inp.length - last - 1);
