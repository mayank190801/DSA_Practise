    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            for(int i = 0; i < n; i++){
                ...
                int idx = 0;
                int value = primeNumbers.get(idx);
                while(value*value <= curr){    //there would be faster function for doing this
                    while(curr % value == 0){
                        curr = curr/value;
                    ...
                    //now move value forward
                    idx++;
                    value = primeNumbers.get(idx);            
                }
            ...
            //till the map, this code is working pretty smooth according to me
            //let's code it out 
            int ans = 0;
            int left = 0;
