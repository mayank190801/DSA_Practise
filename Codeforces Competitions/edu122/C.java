...
public class C{
    ...
    public static void main(String[] args) {
       ...
       while(test --> 0){
           ...
           for(long i = 0; i <= k; i++){
               //1 isme baaki usme and so on
               long nd1 = d1 + (k-i)*attack;  //making of new variable everytime!!
               long nh1 = h1 + i*health;       //making of new variable everytime!! 
            
               //now checkl
                // long counttimes = (long)Math.ceil(h2/d1);
                // long secondtimes = (long)Math.ceil(h1/d2);
               long counttimes = h2/nd1;
               if(h2%nd1 != 0) counttimes++;
               long secondtimes = nh1/d2;
               if(nh1%d2 != 0) secondtimes++;

               if(counttimes <= secondtimes) possible = true;
           }
