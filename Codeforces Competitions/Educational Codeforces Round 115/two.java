...
public class two{
    ...
    public static void main(String[] args) {
        ...
        while(test-- >0){
            ...
            //now count in each day, and then count common in both of them
            int[] arr = new int[5];
            for(int i = 0; i < 5; i++){
                int count = 0;
                for(int j = 0; j < n; j++){
            ...
            for(int i = 0; i < 5; i++){
                ...
                for(int j = i+1; j < 5; j++){
                    int common = 0;
                    if(arr[j] < n/2) continue;

                    for(int k = 0; k < n; k++){
                        if(temp[k][i] == temp[k][j]) common++;
                    }
                    ...
                    if(common > 0){
                        common -= (first >= n/2 ? first - n/2 : 0);
                        common -= (second >= n/2 ? second - n/2 : 0);
                    }
            ...
            if(flag) out.println("YES"); else out.println("NO");
