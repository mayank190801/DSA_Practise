...
public class E{
    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            up = sc.nextLine().toCharArray();
            down = sc.nextLine().toCharArray();

            //after this 
            //simple solve it for block wise
            int[] above = new int[n];
            int[] below = new int[n];

            //now solve for left for now please 
            int uidx = -1;
            int bidx = -1;
            for(int i = 0; i < n; i++){
                //there could be four cases everytime simple
