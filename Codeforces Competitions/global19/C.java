...
public class C{
    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            //one fucking exceptional which needed to be handled precisley
            //fuck me seriously brother
            //left with only hour for the hardest question out there bruh
            //pretty annoying for sure!! jldi jdli mein hug do achche se!! 
            //bc
            if(n == 3 && arr[1]%2 == 1){
                out.println(-1);
                continue;
