...
public class C{
    ...
    public static void main(String[] args) throws IOException{
        ...
        // StringTokenizer st = new StringTokenizer(r.readLine());  //given line ko tokenize krna simple
        ...
        while(test--> 0){
            ...
            //you output something always!! fucking always
            ...
            while(true){
                ...
                if(N == 1){  //chances of 8 is 1/8
                    out.println("10000000");
                    out.flush();
                    continue;
                }

                if(N == 2){  //convert to 6 asap
                    out.println("11111100");
                    out.flush();
                    continue;
                }

                if(N == 3){ //convert to 5 asap
                    out.println("10000000");
                    out.flush();
                    continue;
                }

                if(N == 4){  //convert to 3 or 5
                    out.println("11110000");
                    out.flush();
                    continue;
                }

                if(N == 5){  //convert to 4 or 6
                    out.println("10000000");
                    out.flush();
                    continue;
                }

                if(N == 6){  //convert to 5 or 7
                    out.println("11000000");
                    out.flush();
                    continue;
                }

                if(N == 7){  //1/8 chances of winning
                    out.println("10000000");
                    out.flush();
                    continue;
                }
