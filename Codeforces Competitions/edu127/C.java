...
public class C{
    ...
    public static void main(String[] args) {
        ...
        //code here
        int test = sc.nextInt();
        //not much on my vscode forsure

        while(test -->0){
            //always work in long for life bro
            long n = sc.nextLong();
            ...
            //how to check for both of  them huh? 
            //pretty smooth keyboard for sure man! (totally love it bruh!)
            //some pretty set stuff, definitely helps a lot bruh
    ...
    public static boolean isVowel(char c)
    {
        ...
        //not much on my vscode forsure' || c=='o' || c=='O' ||     c=='u' || c=='U');
    }   
