...
public class three{
    ...
    public static void main(String[] args) {
        ...
        while(test -- > 0){
            ...
            //convert that x in terms of kth shit 
            //and find the number which
            //count asterisk by each division 
            ...
            char[] dumy = temp.toString().toCharArray();
            // out.println(Arrays.toString(dumy));

            // out.println(pos);
            ArrayList<Long> imp = new ArrayList<>();
            ArrayList<Long> copy = new ArrayList<>();

            for(long curr : pos){
                if(curr != 0) imp.add((curr)*k + 1L);
            }
            ...
            String finalanswer = sb.reverse().toString();
