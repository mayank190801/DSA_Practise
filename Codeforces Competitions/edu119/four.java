...
public class four{
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Pair> list = new ArrayList<>(queries);
        ...
        while(queries -- > 0){
            ...
            if(x == 1){
                ...
                int y = sc.nextInt();
                int z = sc.nextInt();
                list.add(new Pair(y,z));
            }
        }        

        //now since i know this bad boy and shit for sure, let's figure something else out
        ...
        for(int i= list.size()-1 ; i >= 0; i--){
            ...
            if(curr.b == -1){
                //check if the conversion exist or not
                //this below is the most obvious one for sure boi
                if(map.containsKey(curr.a)){
                    ans.add(map.get(curr.a));
                }else{
                    ans.add(curr.a);
                }
            }else{
                if(map.containsKey(curr.b)){
                    map.put(curr.a, map.get(curr.b));
                }else{
                    map.put(curr.a, curr.b);
                }
            }
        }
