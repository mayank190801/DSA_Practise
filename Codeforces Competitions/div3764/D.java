...
public class D{
    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            //if at some case 6 4 2 
            boolean check = false;
            if(((ans[0] - ans[k-1])% 2 == 0) && ans[0] != 0 && ans[k-1] != 0 && ans[0]%2 == 0 && ans[k-1]%2== 0 && (ans[0] != ans[k-1])) check= true;
            ...
            if(check){
                ...
                if(cm != 0 && cn != 0){
                    int fi = 0;
                    //might be facing som eissues hre
                    if(cm < cn){
                        fi = min;
                    }else{
                        fi = max-1;
