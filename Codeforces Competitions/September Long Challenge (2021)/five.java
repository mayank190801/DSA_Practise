...
public class five{
    ...
    public static void main(String[] args) {
        ...
        while(test -- > 0){
            //now think of how to move forward
            int n = sc.nextInt();
            ...
            //now i have the question logic and let's try solving it using O(n2) approach
            long globalMinima = Integer.MAX_VALUE;
            ...
            for(int i =  0; i < n ; i++){
                ...
                for(int j = 0; j< n; j++){
                    ...
                    //now guess how many operations would it take to convert this idiot
                    //let's think of how you can solve it
                    long reqf = first - currf;
                    long reqs = second - currs;

                    //somewhere in here one of those conditions might be wrong
                    //let's think about how where did i went wron
                    ...
                    if(Math.abs(reqf) == Math.abs(reqs)){
                        localMinimal++;
                        continue;
                    }
                ...
                globalMinima = Math.min(localMinimal, globalMinima);
            }

            out.println(globalMinima);
        }
        out.close();
    }
