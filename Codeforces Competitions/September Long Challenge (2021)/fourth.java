...
public class fourth{
    ...
    public static void main(String[] args) {
        ...
        while(test -- > 0){
            ...
            Map<Integer,Integer> countAgain = new HashMap<>();
            
            //simple calculation and maths for in here
            for(int i : arr){
                count.putIfAbsent(i, 0);
                count.put(i, count.get(i) + 1);

                int curr = i^x;
                countAgain.putIfAbsent(curr, 0);
                countAgain.put(curr, countAgain.get(curr) + 1);
            }
            ...
            //now traverse through both of the hashmap to find the best case possible for our boys
            ...
            for(int i : count.keySet()){
                ...
                int second = 0;
                if(countAgain.containsKey(i)) second = countAgain.get(i);
                int total = count.get(i) + second;
                ...
                if(max <= total){
                    if(max < total){
                       ...
                       operations = Math.min(operations, second);
                    }
                }
            }

            out.println(max + " " + operations);
        }
