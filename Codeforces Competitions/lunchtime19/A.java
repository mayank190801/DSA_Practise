...
public class A{
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < m; i++){
            ...
            seg.updateRangeLazy(0, n-1, l-1, r-1, q, 1);
        }

        ArrayList<Integer> ans = new ArrayList<>();
        for(int i= 0; i < n; i++){
            int curr = (int)seg.queryLazy(0, n-1, i, i, 1);
            ans.add(curr);
        }
    ...
    public static class segmentTreeLazy{
        ...
        public long queryLazy(int s, int e, int qs, int qe, int index){
            ...
            if(lazy[index] != Integer.MAX_VALUE){
                ...
                lazy[index] = Integer.MAX_VALUE; //clear the lazy value at current node for sure
            }
        ...
        public void updateRangeLazy(int s, int e, int l, int r, int inc, int index){
            ...
            if(lazy[index] != Integer.MAX_VALUE){
                ...
                lazy[index] = Integer.MAX_VALUE; //clear the lazy value at current node for sure//clear the lazy value at current node for sure
            }
