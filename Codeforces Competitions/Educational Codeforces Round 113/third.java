...
public class third{
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(Arrays.toString(preComp));
        ...
        while(test -- > 0){
            ...
            for(index=0; index < n;index++){
                if(arr[index] == max) maxCount++;
                else break;
            }

            if(maxCount > 1){
                //how to get n! factorial fast??
                //by precomputing heheh
            ...
            max = arr[index];
            for(;index < n;index++){
                if(arr[index] == max) secondMax++;
                else break;
            }

            
            long sum = 0;
            for(int i = n-2 ; i >= secondMax; i--){
                sum += preComp[i];
                sum %= mod;
            }
            ...
            secondMax++;
            // out.println(sum);
            sum *= preComp[n-secondMax];
            sum %= mod;
            // out.println(sum);

            out.println(((preComp[n-1]%mod)*((n-1)%mod)) - sum);
