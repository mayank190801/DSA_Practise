...
public class upsolvefour{
    ...
    public static void main(String[] args) {
        ...
        while(test -- > 0){
            ...
            //yeah kinda makes some sense now if you think
            for(int i= 0; i < m;  i++){
                arr[i] = sc.nextInt();
                sorted[i] = arr[i];
            }
            ...
            for(int i= 0; i < m; i++){
                mapping.putIfAbsent(sorted[i], new ArrayList<>());
                var list = mapping.get(sorted[i]);
                list.add(i);
            }
            ...
            for(int i= 0; i < m ; i++){
                ...
                var list = mapping.get(curr);
                int index = list.get(list.size()-1);
                list.remove(list.size()-1);
                mapping.put(curr ,list);
