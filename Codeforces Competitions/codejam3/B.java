...
public class B{
    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            //if k==1 hwo will you do it? brother?
            long sum = 0;
            long squareSum = 0;
            long sumSquare = 0;
            ...
            sumSquare = sum * sum;
            // out.println(squareSum + " " + sumSquare);

            //now check is possible or not
            out.print("Case #" + cases + ": ");
            // if(sumSquare == squareSum){
            //     //add simply 0 both sides
            //     out.print(obj);
            //     cases++;
            //     continue;
            // }
            ...
            while(l <= r){
                ...
                long left = (sum + middle) * (sum + middle);
                long right = squareSum + (middle * middle);
                if(left == right) {
                    ans = middle;
                    break;                    
                }else if(left < right){
