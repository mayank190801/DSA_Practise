...
public class first{
    ...
    public static long calulate(long curr){
    ...
    public static void main(String[] args) throws IOException{
        ...
        while(test -- > 0){
            ...
            //let's think about this one for real now
            //save previous answer?
            //and save an array to store till now sums for 
            ...
            for(int i = 0; i < n; i++){
                ...
                if(count.containsKey(curr)){
                    long val = count.get(curr);
                    long currAddition = (val * (long)(n-i));
                    answer += currAddition;
                    //update count value for sure now
                    count.put(curr, val + i+1);
                }else{
                    count.put(curr, (long)(i+1));
                }
            }       
