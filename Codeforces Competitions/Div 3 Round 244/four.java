    ...
    public static void main(String[] args) {
        ...
        while(test -- > 0){
            ...
            while(!set.isEmpty()){
                ...
                int firsttalks = set.firstKey();
                int lasttalks = set.lastKey();

                int first = set.get(firsttalks);
                int second = 
                ...
                if(set.get(first) == 1){
                    ...
                    set.put(first, set.get(first) -1);
                }

                if(set.get(last) == 1){
                    set.remove(last);
                }else{
                    set.put(last, set.get(last) -1);
                }
            }
