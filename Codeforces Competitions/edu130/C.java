...
public class C{
    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            for(char ch : a){
                if(ch != 'b') sba.append(ch);
            }

            for(char ch : b){
                if(ch != 'b') sbb.append(ch);
            }

            String one = sba.toString();
            String two = sbb.toString();
            ...
            //now count for c from left, simple no?
            int idxa = 0;
            int idxb = 0;
            int counta = 0;
            int countb = 0;
            ...
            while(idxa < n && idxb < n){
                while(idxa < n && a[idxa] != 'c'){
                    if(a[idxa] == 'b') counta ++;
                    idxa++;
                } 
                while(idxb < n && b[idxb] != 'c'){
                    if(b[idxb] == 'b') countb ++;
                    idxb++;  
                } 
            ...
            while(idxa >= 0 && idxb >= 0){
                while(idxa >= 0 && a[idxa] != 'a'){
                    if(a[idxa] == 'b') counta ++;
                    idxa--;
                } 
                while(idxb >= 0 && b[idxb] != 'a'){
                    if(b[idxb] == 'b') countb ++;
                    idxb--;  
                } 
