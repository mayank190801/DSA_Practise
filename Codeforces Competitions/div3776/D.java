...
public class D{
    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            //now making original a
            //simply making orignal for sure
            ...
            for(int i = 1; i < n; i++){
                if(i == 1){
                    ...
                    //now we have that number
                    int found = arr[idx];
                    //finding it in our array
                    ...
                    out.print(steps + " ");
                    //making it that much forward too
                    ArrayList<Integer> store = new ArrayList<>();
                    
                    int start = j+1;
                    for(; start < i; start++){
                        store.add(original[start]);
                    }

                    for(int k = 0; k <= j; k++){
                        store.add(original[k]);
                    }
                    
                    for(int k = 0; k < i; k++){
                        original[k] = store.get(k);
                    }
