...
public class E{
    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            //after this it is pretty simple for sur
            //we would store different number values in it please
            int pointer = 0;
            boolean flag = true;
            for(int i = 0; i < list.size(); i++){
                ...
                if(flag){
                    while(count[pointer] == 0 || pointer == list.get(i).a){
                        pointer++;
                        times++;
                        if(times > n + 1){
                            flag = false;
                ...
                if(flag == false){
                    ans[list.get(i).b] = list.get(i).a;  //think about it    
                }else{
                    ans[list.get(i).b] = pointer;  //think about it
                    count[pointer]--;
                }
