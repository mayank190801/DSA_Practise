    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            while(true){
                ...
                while(r < n && inp[r] != inp[l]){
                    r++;   //think about this boi!!
                }
                ...
                //with this we can find that way shortest  (palindrome and shit)
                int val = 0;
