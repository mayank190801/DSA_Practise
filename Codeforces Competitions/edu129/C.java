...
public class C{
    ...
    public static void main(String[] args) {
        ...
        while(test--> 0){
            ...
            //after this put them in some pair, and sort them for fuck sake, obviously triplet
            ArrayList<Triplet> all = new ArrayList<>();
            for(int i= 0; i < n; i++){
                all.add(new Triplet(a[i], b[i], i));
            }

            //how to compare mutliple pices
            Collections.sort(all,  (aa, bb) -> aa.a == bb.a ? aa.b - bb.b : aa.a - bb.a );
            
            //hopefully everything will be sorted by nows
            boolean checker = true;

            for(int i= 1; i < n; i++){
                if(all.get(i).b >= all.get(i - 1).b){
            ...
            for(int i = 0; i < n; i++){
                map.put(all.get(i).c + 1, i + 1);
            }

            // //otherwise prettty simpe
            ...
            //how would you print all the elements bois?/
