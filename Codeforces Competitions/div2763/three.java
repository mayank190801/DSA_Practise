...
public class three{
    ...
    public static boolean check(long[] arr, long mid){
        //we try to make this shit happen
        long[] extra = new long[arr.length];
