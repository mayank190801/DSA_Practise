...
public class three{
    ...
    public static class Graph{
        ...
        public String print(int[] arr, int k){
            //now print element with only two edges
            int first = 123;
            ...
            //now we have two options as simple as taht
            //at most k-1 edges can be used only
            long currXor = 0;
            long count = 0;
